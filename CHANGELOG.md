...
* Refactor/simplify Mdfwbootstrap vCard Widget
...
* Merge `Mdfwbootstrap_Navbar_Nav_Walker` into `Mdfwbootstrap_Nav_Walker`
...
* Remove Mdfwbootstrap styles from `style.css` and introduced `app.css` for site-specific CSS
* Remove almost all previous default Mdfwbootstrap styling
...
* Use Mdfwbootstrap Nav Walker as default
...
* Change name from BB to Mdfwbootstrap and release to the public
